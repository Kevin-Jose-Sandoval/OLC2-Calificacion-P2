#=
    * Agregué tipos en los parametros de las funciones.
    * nativa <string> no tengo, solo concatené con coma (linea 50)
=#
...
function imprimirReporte(value::Int64,i::String,j::String,k::Int64)
